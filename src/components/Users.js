      ...
      {edit ? (
        <div>
          <button
            ...
            className='bg-blue-500 text-white hover:bg-blue-800 rounded-xl w-28 h-10 m-1 cursor-pointer ml-10'
          >
            Back
          </button>
        </div>
        ...
        <button
          ...
          className='bg-blue-500 hover:bg-blue-800 rounded-xl w-28 h-10 m-1 cursor-pointer ml-10 text-white'
        >
          Edit users
        </button>
      )}
